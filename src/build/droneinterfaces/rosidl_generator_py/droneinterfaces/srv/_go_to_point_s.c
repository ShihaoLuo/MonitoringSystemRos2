...
bool droneinterfaces__srv__go_to_point__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("droneinterfaces.srv._go_to_point.GoToPoint_Request", full_classname_dest, 50) == 0);
  }
  droneinterfaces__srv__GoToPoint_Request * ros_message = _ros_message;
  {  // goal
...
PyObject * droneinterfaces__srv__go_to_point__request__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("droneinterfaces.srv._go_to_point");
...
ROSIDL_GENERATOR_C_EXPORT
bool droneinterfaces__srv__go_to_point__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("droneinterfaces.srv._go_to_point.GoToPoint_Response", full_classname_dest, 51) == 0);
  }
  droneinterfaces__srv__GoToPoint_Response * ros_message = _ros_message;
  {  // res
