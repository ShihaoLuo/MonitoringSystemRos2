...
#include "droneinterfaces/srv/detail/go_to_point__rosidl_typesupport_fastrtps_c.h"
...
using _GoToPoint_Request__ros_msg_type = droneinterfaces__srv__GoToPoint_Request;
...
size_t get_serialized_size_droneinterfaces__srv__GoToPoint_Request(
  const void * untyped_ros_message,
...
static uint32_t _GoToPoint_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_droneinterfaces__srv__GoToPoint_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_droneinterfaces
size_t max_serialized_size_droneinterfaces__srv__GoToPoint_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
static size_t _GoToPoint_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_droneinterfaces__srv__GoToPoint_Request(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, droneinterfaces, srv, GoToPoint_Request)() {
...
using _GoToPoint_Response__ros_msg_type = droneinterfaces__srv__GoToPoint_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_droneinterfaces
size_t get_serialized_size_droneinterfaces__srv__GoToPoint_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _GoToPoint_Response__ros_msg_type * ros_message = static_cast<const _GoToPoint_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_droneinterfaces__srv__GoToPoint_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_droneinterfaces
size_t max_serialized_size_droneinterfaces__srv__GoToPoint_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
static size_t _GoToPoint_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_droneinterfaces__srv__GoToPoint_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, droneinterfaces, srv, GoToPoint_Response)() {
...
// already included above
// #include "droneinterfaces/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "droneinterfaces/srv/go_to_point.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, droneinterfaces, srv, GoToPoint)() {
