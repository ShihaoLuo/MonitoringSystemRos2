...
#include "droneinterfaces/srv/detail/go_to_point__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const droneinterfaces::srv::GoToPoint_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  droneinterfaces::srv::GoToPoint_Request & ros_message)
{
  // Member: goal
  {
    cdr >> ros_message.goal;
...
{
  auto typed_message =
    static_cast<const droneinterfaces::srv::GoToPoint_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<droneinterfaces::srv::GoToPoint_Request *>(
    untyped_ros_message);
...
static size_t _GoToPoint_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_GoToPoint_Request(full_bounded, is_plain, 0);
...
{
  return &droneinterfaces::srv::typesupport_fastrtps_cpp::_GoToPoint_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, droneinterfaces, srv, GoToPoint_Request)() {
  return &droneinterfaces::srv::typesupport_fastrtps_cpp::_GoToPoint_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_droneinterfaces
cdr_serialize(
  const droneinterfaces::srv::GoToPoint_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: res
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  droneinterfaces::srv::GoToPoint_Response & ros_message)
{
  // Member: res
  {
    uint8_t tmp;
...
{
  auto typed_message =
    static_cast<const droneinterfaces::srv::GoToPoint_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<droneinterfaces::srv::GoToPoint_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
static size_t _GoToPoint_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_GoToPoint_Response(full_bounded, is_plain, 0);
...
{
  return &droneinterfaces::srv::typesupport_fastrtps_cpp::_GoToPoint_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, droneinterfaces, srv, GoToPoint_Response)() {
  return &droneinterfaces::srv::typesupport_fastrtps_cpp::_GoToPoint_Response__handle;
}
...
{
  return &droneinterfaces::srv::typesupport_fastrtps_cpp::_GoToPoint__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, droneinterfaces, srv, GoToPoint)() {
  return &droneinterfaces::srv::typesupport_fastrtps_cpp::_GoToPoint__handle;
}
