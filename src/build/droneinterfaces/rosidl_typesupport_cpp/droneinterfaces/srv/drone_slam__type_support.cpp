...
static const _DroneSlam_Request_type_support_symbol_names_t _DroneSlam_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, droneinterfaces, srv, DroneSlam_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, droneinterfaces, srv, DroneSlam_Request)),
  }
};
...
{
  return &::droneinterfaces::srv::rosidl_typesupport_cpp::DroneSlam_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, droneinterfaces, srv, DroneSlam_Request)() {
  return get_message_type_support_handle<droneinterfaces::srv::DroneSlam_Request>();
}
...
static const _DroneSlam_Response_type_support_symbol_names_t _DroneSlam_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, droneinterfaces, srv, DroneSlam_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, droneinterfaces, srv, DroneSlam_Response)),
  }
};
...
{
  return &::droneinterfaces::srv::rosidl_typesupport_cpp::DroneSlam_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, droneinterfaces, srv, DroneSlam_Response)() {
  return get_message_type_support_handle<droneinterfaces::srv::DroneSlam_Response>();
}
...
static const _DroneSlam_type_support_symbol_names_t _DroneSlam_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, droneinterfaces, srv, DroneSlam)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, droneinterfaces, srv, DroneSlam)),
  }
};
...
{
  return &::droneinterfaces::srv::rosidl_typesupport_cpp::DroneSlam_service_type_support_handle;
}
