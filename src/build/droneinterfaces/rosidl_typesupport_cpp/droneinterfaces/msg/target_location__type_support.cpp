...
static const _TargetLocation_type_support_symbol_names_t _TargetLocation_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, droneinterfaces, msg, TargetLocation)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, droneinterfaces, msg, TargetLocation)),
  }
};
...
{
  return &::droneinterfaces::msg::rosidl_typesupport_cpp::TargetLocation_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, droneinterfaces, msg, TargetLocation)() {
  return get_message_type_support_handle<droneinterfaces::msg::TargetLocation>();
}
