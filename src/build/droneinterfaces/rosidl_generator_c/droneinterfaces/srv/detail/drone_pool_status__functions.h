...
#ifndef DRONEINTERFACES__SRV__DETAIL__DRONE_POOL_STATUS__FUNCTIONS_H_
#define DRONEINTERFACES__SRV__DETAIL__DRONE_POOL_STATUS__FUNCTIONS_H_
...
/// Initialize srv/DronePoolStatus message.
/**
...
/// Finalize srv/DronePoolStatus message.
/**
...
/// Create srv/DronePoolStatus message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * droneinterfaces__srv__DronePoolStatus_Request__init().
...
/// Destroy srv/DronePoolStatus message.
/**
 * It calls
 * droneinterfaces__srv__DronePoolStatus_Request__fini()
...
/// Initialize array of srv/DronePoolStatus messages.
/**
...
/// Finalize array of srv/DronePoolStatus messages.
/**
 * It calls
 * droneinterfaces__srv__DronePoolStatus_Request__fini()
...
/// Create array of srv/DronePoolStatus messages.
/**
 * It allocates the memory for the array and calls
 * droneinterfaces__srv__DronePoolStatus_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/DronePoolStatus messages.
/**
 * It calls
 * droneinterfaces__srv__DronePoolStatus_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * droneinterfaces__srv__DronePoolStatus_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_droneinterfaces
...
/**
 * It calls
 * droneinterfaces__srv__DronePoolStatus_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_droneinterfaces
...
/**
 * It allocates the memory for the array and calls
 * droneinterfaces__srv__DronePoolStatus_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_droneinterfaces
...
/**
 * It calls
 * droneinterfaces__srv__DronePoolStatus_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // DRONEINTERFACES__SRV__DETAIL__DRONE_POOL_STATUS__FUNCTIONS_H_
