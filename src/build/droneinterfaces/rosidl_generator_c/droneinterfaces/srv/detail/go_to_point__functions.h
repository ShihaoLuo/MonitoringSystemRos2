...
#ifndef DRONEINTERFACES__SRV__DETAIL__GO_TO_POINT__FUNCTIONS_H_
#define DRONEINTERFACES__SRV__DETAIL__GO_TO_POINT__FUNCTIONS_H_
...
/// Initialize srv/GoToPoint message.
/**
...
/// Finalize srv/GoToPoint message.
/**
...
/// Create srv/GoToPoint message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * droneinterfaces__srv__GoToPoint_Request__init().
...
/// Destroy srv/GoToPoint message.
/**
 * It calls
 * droneinterfaces__srv__GoToPoint_Request__fini()
...
/// Initialize array of srv/GoToPoint messages.
/**
...
/// Finalize array of srv/GoToPoint messages.
/**
 * It calls
 * droneinterfaces__srv__GoToPoint_Request__fini()
...
/// Create array of srv/GoToPoint messages.
/**
 * It allocates the memory for the array and calls
 * droneinterfaces__srv__GoToPoint_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/GoToPoint messages.
/**
 * It calls
 * droneinterfaces__srv__GoToPoint_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * droneinterfaces__srv__GoToPoint_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_droneinterfaces
...
/**
 * It calls
 * droneinterfaces__srv__GoToPoint_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_droneinterfaces
...
/**
 * It allocates the memory for the array and calls
 * droneinterfaces__srv__GoToPoint_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_droneinterfaces
...
/**
 * It calls
 * droneinterfaces__srv__GoToPoint_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // DRONEINTERFACES__SRV__DETAIL__GO_TO_POINT__FUNCTIONS_H_
