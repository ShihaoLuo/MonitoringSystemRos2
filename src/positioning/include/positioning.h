...
private:
    ...
    droneinterfaces::msg::TargetLocation targetLocation_, targetLocation2_;
    ...
    rclcpp::Publisher<droneinterfaces::msg::TargetLocation>::SharedPtr targetLocationPublisher2_;
    ...
    cv::Mat *worldPoint, *worldPoint2;
    std::array<float, 3UL> targetWorldPoint={-10000, -10000, -10000}, targetWorldPoint2={-10000, -10000, -10000}, oldTargetWorldPoint={-10000, -10000, -10000}, defaultLostLocation={-10000, -10000, -10000};
