...
static const _DroneRegister_Request_type_support_symbol_names_t _DroneRegister_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, droneinterfaces, srv, DroneRegister_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, droneinterfaces, srv, DroneRegister_Request)),
  }
};
...
{
  return &::droneinterfaces::srv::rosidl_typesupport_cpp::DroneRegister_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, droneinterfaces, srv, DroneRegister_Request)() {
  return get_message_type_support_handle<droneinterfaces::srv::DroneRegister_Request>();
}
...
static const _DroneRegister_Response_type_support_symbol_names_t _DroneRegister_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, droneinterfaces, srv, DroneRegister_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, droneinterfaces, srv, DroneRegister_Response)),
  }
};
...
{
  return &::droneinterfaces::srv::rosidl_typesupport_cpp::DroneRegister_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, droneinterfaces, srv, DroneRegister_Response)() {
  return get_message_type_support_handle<droneinterfaces::srv::DroneRegister_Response>();
}
...
static const _DroneRegister_type_support_symbol_names_t _DroneRegister_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, droneinterfaces, srv, DroneRegister)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, droneinterfaces, srv, DroneRegister)),
  }
};
...
{
  return &::droneinterfaces::srv::rosidl_typesupport_cpp::DroneRegister_service_type_support_handle;
}
